...
model_params.alphaMin=model_params.alphaInitial*0.05;
model_params.momentumInitial=0.5;
model_params.momentumMax=0.95;
model_params.batchSize=64;
model_params.loglevel=2;
model_params.alphaBiasMultiplier=2; %bias updates are usually stronger
model_params.initializationNoiseType='normal'; %"normal" or "uniform"
...
model_params.tuneInitialWeights=1;
...
model_params.generator.unitTypes={'uniform';'sigmoid';'sigmoid'}; % "sigmoid|relu|stochastic", first layer must be 'uniform' (noise distribution)
model_params.generator.initBiasToData=1; %initialize biases to mean values
model_params.generator.randomWeightMultiplier=.1;
model_params.generator.weightDecay=0.001;
model_params.generator.sparseInit=0;
model_params.generator.alphaScale=.5; %make LR of generator smaller or bigger

model_params.generator.alphaAutoAdjust=1;%not implemented
...
model_params.discriminator.unitTypes={'sigmoid';'sigmoid'}; %sigmoid, relu or maxout, type of last layer must be sigmoid
