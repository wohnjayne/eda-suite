...
epsilonvb     = 0.5;   % Learning rate for biases of visible units 
epsilonhb     = 0.5;   % Learning rate for biases of hidden units 
...
%%%%%%%%%%%%%%%% END OF UPDATES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
  ...
  if model_params.loglevel>1 && mod(epoch,20)==0
      ...
      title("RBM1 recon err");
      figure(778);
      plot(1:epoch,epocherrors_smooth);
      title("RBM1 recon err smooth");
      refresh();
  end
...
save (strcat("fullmnistvh",model.myrun), "vishid", "visbiases", "hidbiases"  )
