...
model_params.corruptInput=0.05; %Denoising autoencoder, more corruption seems to lead to faster convergence of EDA (perhaps, lower corruption leads more often to identiy function being learned...?)
