...
model_params.breakOnRelativeGain=0.15;
model_params.sampleFromRandom=1;
model_params.corruptInput=0.1; %Denoising autoencoder, more corruption seems to lead to faster convergence of EDA (perhaps, lower corruption leads more often to identiy function being learned...?)
